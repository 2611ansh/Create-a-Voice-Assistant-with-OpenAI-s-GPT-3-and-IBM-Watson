...
openai.api_key = "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"
...
def openai_process_message(user_message):
    ...
    openai_response = openai.Completion.create(model="gpt-3.5-turbo", prompt=prompt,max_tokens=4000)
